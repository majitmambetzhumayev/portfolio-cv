...
export default function ProjectsSection() {
  ...
  const projectIds = ['saas', 'management', 'api', 'taskmanager'] as const;
        ...
        {projectIds.map(projectId => {
          ...
          return (
            ...
            >
              ...
              <div className="absolute -inset-x-4 -inset-y-4 z-0 hidden group-hover:shadow-xl rounded-lg transition motion-reduce:transition-none lg:-inset-x-6 lg:block lg:group-hover:bg-neutral-400/10" />
